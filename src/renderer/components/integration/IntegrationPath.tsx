...
import {
    Upload, FileText, Server, HardDrive, CheckCircle,
    X, Download, RefreshCw, Edit3, ArrowRight
} from 'lucide-react';
...
export default function IntegrationPath() {
    const {
        ...
        currentStep, getStepName, setSkillsState, skillsState
    } = useAppStore();
    ...
    const sampleFiles: SampleFile[] = [
        ...
        {
            name: 'Employee Data',
            path: '/samples/employees/employee_sample.csv',
            description: 'Sample employee records',
            skillCount: 10
        },
    ];
    ...
    const handleFileSelect = useCallback(async (file: File) => {
        ...
        try {
            ...
            // Extract skills
            const response = await api.post<{ skills: Skill[], total_count: number, file_id?: string }>('/api/skills/extract/csv', {
                filename: file.name,
            ...
            if (response.file_id) {
                safeStorage.setItem('profstudio_csv_file_id', response.file_id);
                setCsvFileId(response.file_id);
            }
            ...
            // Show CSV editor automatically so user can review data
            if (response.file_id) {
    ...
    const handleSampleLoad = useCallback(async (sample: SampleFile) => {
        try {
            ...
            <Card className="border-none shadow-none bg-transparent">
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground">
                        Select how you want to import your skills data
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        >
                            <CardContent className="p-6 text-center pt-8">
                                ...
                                <p className="text-sm text-gray-500 mb-4">Upload a CSV file with your skills data</p>
                                <Button variant="outline" className="w-full">Select CSV</Button>
                            </CardContent>
                        </Card>
                        ...
                        >
                            <CardContent className="p-6 text-center pt-8">
                                ...
                                <p className="text-sm text-gray-500 mb-4">Connect to SFTP server to download files</p>
                                <Button variant="outline" className="w-full">Select SFTP</Button>
                            </CardContent>
                        </Card>
                        ...
                        >
                            <CardContent className="p-6 text-center pt-8">
                                ...
                                <p className="text-sm text-gray-500 mb-4">Connect to Eightfold API to fetch roles</p>
                                <Button variant="outline" className="w-full">Select API</Button>
                            </CardContent>
                        </Card>
                    </div>
                )}
                    ...
                    <div className="space-y-6 max-w-2xl mx-auto">
                        <div
                            className={cn(
                                ...
                                csvUploadStatus === 'success' && 'border-green-500 bg-green-50 dark:bg-green-900/20',
                        ...
                        {/* Continue button - shown after successful upload */}
