...
const Settings: React.FC = () => {
  ...
  const [apiKeys, setApiKeys] = useState<ApiKeys>({ gemini: '', kimi: '' });
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <nav
          className="w-56 border-r border-border bg-card p-4 space-y-1"
                    ...
                    <CardContent className="space-y-4">
                      <SettingRow
                        ...
                        onCheckedChange={(checked) =>
                          updateGeneralSetting('reducedMotion', checked)
                        }
                      />
                      <SettingRow
                        label="Compact Mode"
                  ...
                  <Card variant="glass">
                    <CardContent className="pt-6 space-y-4">
                      <SettingRow
                        ...
                        onCheckedChange={(checked) =>
                          updateGeneralSetting('notifications', checked)
                        }
                      />
                      <SettingRow
                        ...
                        onCheckedChange={(checked) =>
                          updateGeneralSetting('desktopNotifications', checked)
                        }
                      />
                    </CardContent>
                  </Card>
            ...
            {activeTab === 'keys' && (
              <>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Configure access tokens for AI services
                  </p>
                </div>
                    ...
                    <CardContent className="pt-6 space-y-6">
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <label htmlFor="settings-gemini-key" className="text-sm font-medium">
                        ...
                        <div className="flex gap-2">
                          ...
                          />
                          <Button onClick={() => saveApiKey('GEMINI_API_KEY', apiKeys.gemini)}>
                            Save
                          </Button>
                        </div>
                      </div>
                      ...
                      <div className="border-t border-border pt-6 space-y-3">
                        <div className="flex items-center justify-between">
                          <label htmlFor="settings-kimi-key" className="text-sm font-medium">
                            Kimi API Key{' '}
                            <span className="text-muted-foreground">(Moonshot AI)</span>
                          </label>
                        ...
                        <div className="flex gap-2">
                          ...
                          />
                          <Button onClick={() => saveApiKey('KIMI_API_KEY', apiKeys.kimi)}>
                            Save
                          </Button>
                        </div>
                      </div>
            ...
            {activeTab === 'ai' && config && (
              <>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Configure AI models and data storage
                  </p>
                </div>
                ...
                <motion.div variants={fadeUp}>
                  <Card variant="glass">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Choose how embeddings are stored and searched
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            AI-Powered Proficiency Assessment Platform
                          </p>
                        </div>
                      </div>
      ...
      <ConfirmDialog
        ...
        description="Are you sure? This will clear all local data and cannot be undone."
